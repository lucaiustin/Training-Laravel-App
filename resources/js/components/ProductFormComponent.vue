    ...
    <div>
        <div class="container">
            <form method="POST"  v-on:submit.prevent="onSubmit" >
                <input type="text" v-model="title" placeholder="Title" value="title" required>
                <span v-model="titleErrors">{{ titleErrors }}</span>
                <br>
                <input type="text" v-model="description" placeholder="Description" value="description" required>
                <span v-model="descriptionErrors">{{ descriptionErrors }}</span>
                <br>
                <input type="text" v-model="price" placeholder="Price" value="price" required>
